...
const Navbar = () => {
  ...
  const handleSignOut = () =>{
    ...
    <NavLink  className="mr-3" to="/bills">Bills</NavLink>
    <NavLink  className="mr-3" to="/auth/login">Login</NavLink>
    <NavLink  className="mr-3" to="/auth/register">Register</NavLink>
    </>
    const links2 = <>
    <NavLink  className="mr-3" to="/">Home</NavLink>
    <NavLink  className="mr-3" to="/bills">Bills</NavLink>
    <NavLink  className='mr-3' to="/my-pay-bills">MyPayBills</NavLink>
...
<div className="flex items-center gap-3 mb-4  hidden lg:block">
  ...
  <div className="flex gap-2">
    <div className='flex gap-5 items-center hidden md:block lg:block'>
        {user ? links2 : links}
         <input
