        ...
        <div className='my-30'>
         ...
         {latestBills.map(bill => <BillsCard key={bill._id} bill={bill}/>)}
           ...
           <button
                ...
                className="mx-auto mt-10   cursor-pointer max-w-3xl  hover:from-blue-600 hover:to-blue-700  font-medium py-3 px-4 rounded-lg transition-all duration-200 transform hover:shadow-lg active:scale-95 flex items-center justify-center group">
                    See all ...
